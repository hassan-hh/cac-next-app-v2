    ...
    return (
            <nav className="bg-gray-800">
                <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                    ...
                    <div className="transition duration-500 ease-in-out absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div className="sm:hidden transition duration-500 ease-in-out" id="mobile-menu">
