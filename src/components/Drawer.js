...
const Drawer = () => {
    ...
    const { systemDate, accountEntity } = useContext(DrawerContext)
    ...
    console.log('drawer', systemDate)
    console.log('account', accountEntity)

    return (
        <div className="flex flex-col justify-between h-80 p-4">
            <p key="date">System Date {systemDate && formatedDate}</p>
